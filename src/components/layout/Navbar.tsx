      ...
      >
        ...
        >
          <div className="px-4 py-4 space-y-1 bg-white max-h-[70vh] overflow-y-auto">
            ...
            {/* Mobile promo bar */}
            <div className="mt-3 mx-1 bg-gradient-corp rounded-xl px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 bg-white/20 hover:bg-white/30 rounded-lg px-3 py-1.5 transition-colors"
              >
